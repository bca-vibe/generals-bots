...
The top policy was **c14000_t0.5** with macro score **0.5197** across the other 14 variants.

## Ranking

| Rank | Policy | Checkpoint | Inference | Temperature | Macro score | W-L-D |
|---:|---|---:|---|---:|---:|---:|
| 1 | c14000_t0.5 | 14,000 | categorical | 0.5 | 0.5197 | 2091-1930-75 |
| 2 | c14000_t0.25 | 14,000 | categorical | 0.25 | 0.5148 | 2067-1946-83 |
| 3 | c14000_greedy | 14,000 | greedy | — | 0.5046 | 2028-1990-78 |
| 4 | c14000_t0.75 | 14,000 | categorical | 0.75 | 0.4907 | 1976-2052-68 |
| 5 | c14000_t1 | 14,000 | categorical | 1 | 0.4702 | 1894-2138-64 |
...
- 10 off-diagonal matchups; 1,024 games per matchup on 512 maps, with both player-seat assignments.
- 10,240 games total.
- The same locked map set was used for every matchup. Map seed: `202608075`; base action seed: `202608076`.
