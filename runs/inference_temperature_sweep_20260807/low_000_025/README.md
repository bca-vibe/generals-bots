...
The top policy was **c14000_greedy** with macro score **0.5073** across the other 14 variants.

## Ranking

| Rank | Policy | Checkpoint | Inference | Temperature | Macro score | W-L-D |
|---:|---|---:|---|---:|---:|---:|
| 1 | c14000_greedy | 14,000 | greedy | — | 0.5073 | 2545-2470-105 |
| 2 | c14000_t0.25 | 14,000 | categorical | 0.25 | 0.5026 | 2526-2499-95 |
| 3 | c14000_t0.1 | 14,000 | categorical | 0.1 | 0.4999 | 2510-2511-99 |
| 4 | c14000_t0.05 | 14,000 | categorical | 0.05 | 0.4994 | 2516-2522-82 |
| 5 | c14000_t0.15 | 14,000 | categorical | 0.15 | 0.4984 | 2495-2511-114 |
| 6 | c14000_t0.2 | 14,000 | categorical | 0.2 | 0.4923 | 2470-2549-101 |
...
- 15,360 games total.
- The same locked map set was used for every matchup. Map seed: `202608079`; base action seed: `202608080`.
